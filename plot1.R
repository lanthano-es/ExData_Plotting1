...
## This script is for generation of plot1.
...
## Create the histogram in screen device:
hist(df.housepwr[,"Global_active_power"],     ## define data of histogram 
     main = "Global Active Power",            ## define Main title of graph  
     xlab="Global Active Power (kilowatts)",  ## define x-asis title of graph
     ylab="Frequency",                        ## define y-asis title of graph
     col = "red"                              ## define bar's bg-color of graph
);
